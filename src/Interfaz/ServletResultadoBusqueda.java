	...
	public void darEtapas (HttpServletRequest request, PrintWriter respuesta){
		...
		try
		{
			...
			if (!etapas.isEmpty())
			{
        		...
        		respuesta.write( "</table>" );
        		respuesta.write( "<table align=\"center\" bgcolor=\"#ecf0f1\" width=50%>" );
    			respuesta.write( "<tr><td align=\"center\"><input name=\"buscar\" value=\"Buscar\" type=\"submit\"></td></tr>" );
    			respuesta.write( "</table>");
        		respuesta.write( "</form>" );
        		respuesta.write( "<hr>" );
				respuesta.write( "<table align=\"center\" bgcolor=\"#ecf0f1\" width=50%>" );
		        for (Etapa etapa : etapas) {
			        ...
			        respuesta.write( "<tr><td align=\"left\"><h4><input value=\"Id Pedido: \" name=\"label1\" style=\"border: none;\" type=\"text\"\"></h4></td><td align=\"right\">" + etapa.getIdPedido() + "</td></tr>" );
			        respuesta.write( "<tr><td align=\"left\"><h4><input value=\"Dia: \" name=\"label2\" style=\"border: none;\" type=\"text\"\"></h4></td><td align=\"right\">" + etapa.getDia() + "/" + etapa.getMes() + "/2015</td></tr>" );
			        respuesta.write( "<tr><td align=\"left\"><h4><input value=\"Materia Prima: \" name=\"label2\" style=\"border: none;\" type=\"text\"\"></h4></td><td align=\"right\">" + etapa.getIdMateriaPrima() + "</td></tr>" );
			        respuesta.write( "<tr><td align=\"left\"><h4><input value=\"Componente: \" name=\"label2\" style=\"border: none;\" type=\"text\"\"></h4></td><td align=\"right\" size=\"\">" + etapa.getIdComponente() + "</td></tr>" );
			        respuesta.write( "<tr><td align=\"left\"><h4><input value=\"Duracion: \" name=\"label2\" style=\"border: none;\" type=\"text\"\"></h4></td><td align=\"right\" size=\"\">" + etapa.getDuracion() + "</td></tr>" );
			        respuesta.write( "</table></td>" );
			        respuesta.write( "</tr>" );
			        respuesta.write( "<tr></tr>" );
			        respuesta.write( "</form>" );
